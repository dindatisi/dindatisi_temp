...
So I was told about this lecture video a few weeks ago. It's a bit long (47 minutes) and I watched it at 1.30AM. But I didn't regret delaying my bed time to watch this video; I learned a lot. So I'd like to share those learnings here:
...
3. You need to define a northstar (where you want to go)! That northstar metric should be the numbers you look at & report both internally & externally. For example: FB-> DAU, Whatsapp -> total sent messages, Airbnb -> total nights booked, ebay -> GMV.
